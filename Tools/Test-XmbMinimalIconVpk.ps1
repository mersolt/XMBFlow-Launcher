...
$expected = @('eboot.bin', 'index.lua', 'LICENSE', 'sce_sys/icon0.png', 'sce_sys/param.sfo', 'DATA/xmb-icon-settings.png', 'DATA/xmb-icon-photo.png', 'DATA/xmb-icon-music.png', 'DATA/xmb-icon-video.png', 'DATA/xmb-icon-games.png', 'DATA/xmb-icon-apps.png', 'DATA/font-SawarabiGothic-Regular.ttf', 'THIRD-PARTY-NOTICES/SawarabiGothic-OFL.txt')
...
try {
    ...
    foreach ($forbidden in @('ux0:', 'ur0:', 'vs0:', 'System.installVpk', 'System.reboot', 'System.deleteFile', 'System.deleteDirectory', 'System.copyFile', 'dofile(', 'loadfile(', 'Sound.')) {
