...
$expected = @('eboot.bin', 'index.lua', 'LICENSE', 'sce_sys/icon0.png', 'sce_sys/param.sfo', 'DATA/xmb-icon-settings.png', 'DATA/xmb-icon-photo.png', 'DATA/xmb-icon-music.png', 'DATA/xmb-icon-video.png', 'DATA/xmb-icon-games.png', 'DATA/xmb-icon-network.png', 'DATA/xmb-icon-apps.png', 'DATA/xmb-setting-theme.png', 'DATA/xmb-setting-sound.png', 'DATA/xmb-setting-network.png', 'DATA/xmb-setting-display.png', 'DATA/xmb-setting-system.png', 'DATA/xmb-setting-time.png', 'DATA/xmb-object-photoviewer.png', 'DATA/xmb-object-trophy.png', 'DATA/xmb-object-saved-data.png', 'DATA/xmb-cursor.ogg', 'DATA/font-SawarabiGothic-Regular.ttf', 'THIRD-PARTY-NOTICES/SawarabiGothic-OFL.txt')
