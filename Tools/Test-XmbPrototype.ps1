...
$required = @(
    ...
    '"app0:/DATA/xmb-app-options-" .. kind .. ".png"',
    'Graphics.drawScaleImage(panel_x, anchor_y - math.floor(row_height / 2), highlight_texture, 1, 1',
    ...
    'xmb-object-video-library.png',
    'xmb-object-video-settings.png',
    'return {"Information"}',
    'return {"Information", "Delete"}',
    'entry.browser_uri ~= nil',
