...
if (-not $text.Contains('local y = is_previous and 62 or 296 + (option - selected_option) * 66')) { throw 'The preceding object must use the separate above-category XMB slot.' }
