...
if (-not $text.Contains('math.sin(glow_phase / 18)') -or -not $text.Contains('Color.new(255, 255, 255') -or -not $text.Contains('local text_color = Color.new')) { throw 'Focused icons and labels must use the white XMB-style glow pulse.' }
