...
if (-not $text.Contains('XmbLayout.horizontal_x(parent_x, column, visual_column, 130)')) { throw 'The horizontal category axis must interpolate around the submenu-adjusted XMB anchor.' }
