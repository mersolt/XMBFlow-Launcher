...
New-Icon 'xmb-icon-network.png' { param($g) $p=[System.Drawing.Pen]::new($cyan,5); try {$g.DrawEllipse($p,16,16,64,64);$g.DrawArc($p,28,16,40,64,90,180);$g.DrawArc($p,28,16,40,64,270,180);$g.DrawLine($p,16,48,80,48)} finally {$p.Dispose()} }

Write-Host 'Created original XMBFlow category icons.'
