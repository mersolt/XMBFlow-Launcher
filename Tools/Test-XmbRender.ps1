...
foreach ($required in @('XmbRender = {}', 'XmbRender.filtered_images = {}', 'function XmbRender.icon(image, center_x, center_y, scale, color)', 'function XmbRender.glowing_icon(image, center_x, center_y, scale, glow_scale, color, glow_color)', 'function XmbRender.each_category(columns, visual_index, anchor_x, spacing, draw_category)', 'function XmbRender.each_vertical(first_index, last_index, visual_index, anchor_y, down_spacing, up_spacing, draw_item)', 'Graphics.setImageFilters(image, FILTER_LINEAR, FILTER_LINEAR)', 'Graphics.drawScaleImage', 'XmbRender.icon(image, center_x, center_y, glow_scale, glow_color)')) {
