...
foreach ($required in @('XmbRender = {}', 'function XmbRender.icon(image, center_x, center_y, scale, color)', 'function XmbRender.glowing_icon(image, center_x, center_y, scale, glow_scale, color, glow_color)', 'Graphics.drawScaleImage', 'XmbRender.icon(image, center_x, center_y, glow_scale, glow_color)')) {
